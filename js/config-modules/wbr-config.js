// ====== WBR CONFIG ======
// Función principal para cargar la interfaz de configuración del WBR

function loadWBRConfig() {
  console.log('📅 loadWBRConfig() ejecutando...');
  
  const mainContent = document.getElementById('main-content');
  
  const html = `
    <div style="padding: 20px; max-width: 1200px; margin: 0 auto;">
      <h2>📅 Configuración WBR</h2>
      <p style="color: #666; margin-bottom: 20px;">Aquí irá la configuración de estructura WBR</p>
